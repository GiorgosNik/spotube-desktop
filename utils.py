...
def auth_handler():
    genius_auth = lyricsgenius.Genius("5dRV7gMtFLgnlF632ZzqZutSsvPC0IWyFUJ1W8pWHj185RAMFgR4FtX76ckFDjFZ",verbose=False)
...
def first_time_setup():
    ...
    if os.name == 'nt':
        ...
        p = str(subprocess.Popen("which ffmpeg", shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE).communicate()[0])
        if p == "b''":
